...
import neteaseApiContructor from './netease';
import qqApiContructor from './qq';
import {match} from './match';

const api = musicApiContructor(remote.getGlobal('nodeAdapter'));
const neteaseApi = neteaseApiContructor(remote.getGlobal('nodeAdapter'));
const qqApi = qqApiContructor(remote.getGlobal('nodeAdapter'));
